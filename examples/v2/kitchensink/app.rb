...
class KitchensinkApp < Sinatra::Base
  ...
  configure do
    ...
    if code == 200
      logger.info "✅ LINE Webhook URL set to #{webhook_endpoint}"
    else
      logger.error "❌ Failed to set LINE Webhook. code=#{code}, error body=#{body}"
    end
  end
