  ...
  class AcquireChatControlRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LINE::Client::Module::AcquireChatControlRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LINE::Client::Module::AcquireChatControlRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@ttl.nil? && @ttl > 31536000
        invalid_properties.push('invalid value for "ttl", must be smaller than or equal to 31536000.')
      end
    ...
    def valid?
      return false if !@ttl.nil? && @ttl > 31536000
      true
    end
    ...
    def ttl=(ttl)
      if !ttl.nil? && ttl > 31536000
        fail ArgumentError, 'invalid value for "ttl", must be smaller than or equal to 31536000.'
      end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = LINE::Client::Module.const_get(type)
