  ...
  class ButtonsTemplateAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LINE::Client::MessagingApi::ButtonsTemplateAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LINE::Client::MessagingApi::ButtonsTemplateAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'image_background_color')
        self.image_background_color = attributes[:'image_background_color']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          image_background_color == o.image_background_color &&
          title == o.title &&
          text == o.text &&
    ...
    def hash
      [thumbnail_image_url, image_aspect_ratio, image_size, image_background_color, title, text, default_action, actions].hash
    end
