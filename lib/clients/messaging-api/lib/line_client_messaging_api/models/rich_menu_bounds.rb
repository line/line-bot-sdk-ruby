  ...
  class RichMenuBounds
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LINE::Client::MessagingApi::RichMenuBounds` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LINE::Client::MessagingApi::RichMenuBounds`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@x.nil? && @x > 2147483647
        invalid_properties.push('invalid value for "x", must be smaller than or equal to 2147483647.')
      end
      ...
      if !@y.nil? && @y > 2147483647
        invalid_properties.push('invalid value for "y", must be smaller than or equal to 2147483647.')
      end
      ...
      if !@width.nil? && @width > 2147483647
        invalid_properties.push('invalid value for "width", must be smaller than or equal to 2147483647.')
      end
      ...
      if !@height.nil? && @height > 2147483647
        invalid_properties.push('invalid value for "height", must be smaller than or equal to 2147483647.')
      end
    ...
    def valid?
      ...
      return false if !@x.nil? && @x > 2147483647
      return false if !@x.nil? && @x < 0
      return false if !@y.nil? && @y > 2147483647
      return false if !@y.nil? && @y < 0
      return false if !@width.nil? && @width > 2147483647
      return false if !@width.nil? && @width < 1
      return false if !@height.nil? && @height > 2147483647
    ...
    def x=(x)
      ...
      if x > 2147483647
        fail ArgumentError, 'invalid value for "x", must be smaller than or equal to 2147483647.'
      end
    ...
    def y=(y)
      ...
      if y > 2147483647
        fail ArgumentError, 'invalid value for "y", must be smaller than or equal to 2147483647.'
      end
    ...
    def width=(width)
      ...
      if width > 2147483647
        fail ArgumentError, 'invalid value for "width", must be smaller than or equal to 2147483647.'
      end
    ...
    def height=(height)
      ...
      if height > 2147483647
        fail ArgumentError, 'invalid value for "height", must be smaller than or equal to 2147483647.'
      end
