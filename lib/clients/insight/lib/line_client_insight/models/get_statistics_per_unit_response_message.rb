  ...
  class GetStatisticsPerUnitResponseMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LINE::Client::Insight::GetStatisticsPerUnitResponseMessage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LINE::Client::Insight::GetStatisticsPerUnitResponseMessage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unique_impression')
        self.unique_impression = attributes[:'unique_impression']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unique_impression == o.unique_impression &&
    ...
    def hash
      [seq, impression, media_played, media_played25_percent, media_played50_percent, media_played75_percent, media_played100_percent, unique_impression, unique_media_played, unique_media_played25_percent, unique_media_played50_percent, unique_media_played75_percent, unique_media_played100_percent].hash
    end
