    ...
    module V2
      module MessagingApi
        class ApiClient
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/broadcast</tt>
          #
          # @param broadcast_request [BroadcastRequest] 
          # @param x_line_retry_key [String] Retry key. Specifies the UUID in hexadecimal format (e.g., `123e4567-e89b-12d3-a456-426614174000`) generated by any method. The retry key isn't generated by LINE. Each developer must generate their own retry key. 
          ...
          # This requests to <tt>DELETE https://api.line.me/v2/bot/user/all/richmenu</tt>
          #
          ...
          # Create rich menu
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/alias</tt>
          #
          ...
          # Deletes a rich menu.
          # This requests to <tt>DELETE https://api.line.me/v2/bot/richmenu/{richMenuId}</tt>
          #
          ...
          # This requests to <tt>DELETE https://api.line.me/v2/bot/richmenu/alias/{richMenuAliasId}</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/aggregation/list</tt>
          #
          # @param limit [String] The maximum number of aggregation units you can get per request. 
          # @param start [String] Value of the continuation token found in the next property of the JSON object returned in the response. If you can't get all the aggregation units in one request, include this parameter to get the remaining array. 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/aggregation/info</tt>
          #
          ...
          # Get bot info
          # This requests to <tt>GET https://api.line.me/v2/bot/info</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/user/all/richmenu</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/followers/ids</tt>
          #
          # @param start [String] Value of the continuation token found in the next property of the JSON object returned in the response. Include this parameter to get the next array of user IDs. 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/group/{groupId}/members/count</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/group/{groupId}/member/{userId}</tt>
          #
          # @param group_id [String] Group ID
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/group/{groupId}/members/ids</tt>
          #
          # @param group_id [String] Group ID
          # @param start [String] Value of the continuation token found in the `next` property of the JSON object returned in the response. Include this parameter to get the next array of user IDs for the members of the group. 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/group/{groupId}/summary</tt>
          #
          # @param group_id [String] Group ID
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/membership/{membershipId}/users/ids</tt>
          #
          # @param membership_id [Integer] Membership plan ID.
          # @param start [String] A continuation token to get next remaining membership user IDs. Returned only when there are remaining user IDs that weren't returned in the userIds property in the previous request. The continuation token expires in 24 hours (86,400 seconds). 
          # @param limit [Integer] The max number of items to return for this API call. The value is set to 300 by default, but the max acceptable value is 1000. 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/membership/list</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/membership/subscription/{userId}</tt>
          #
          # @param user_id [String] User ID
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/quota</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/quota/consumption</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/progress/narrowcast</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/delivery/broadcast</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/delivery/multicast</tt>
          #
          # @param date [String] Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/delivery/push</tt>
          #
          # @param date [String] Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/delivery/reply</tt>
          #
          # @param date [String] Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/message/delivery/pnp</tt>
          #
          ...
          # Get profile
          # This requests to <tt>GET https://api.line.me/v2/bot/profile/{userId}</tt>
          #
          # @param user_id [String] User ID
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/richmenu/{richMenuId}</tt>
          #
          # @param rich_menu_id [String] ID of a rich menu
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/richmenu/alias/{richMenuAliasId}</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/richmenu/alias/list</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/richmenu/progress/batch</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/user/{userId}/richmenu</tt>
          #
          ...
          # Get rich menu list
          # This requests to <tt>GET https://api.line.me/v2/bot/richmenu/list</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/room/{roomId}/members/count</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/room/{roomId}/member/{userId}</tt>
          #
          # @param room_id [String] Room ID
          # @param user_id [String] User ID
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/room/{roomId}/members/ids</tt>
          #
          # @param room_id [String] Room ID
          # @param start [String] Value of the continuation token found in the `next` property of the JSON object returned in the response. Include this parameter to get the next array of user IDs for the members of the group. 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/channel/webhook/endpoint</tt>
          #
          ...
          # Issue link token
          # This requests to <tt>POST https://api.line.me/v2/bot/user/{userId}/linkToken</tt>
          #
          ...
          # Leave group chat
          # This requests to <tt>POST https://api.line.me/v2/bot/group/{groupId}/leave</tt>
          #
          # @param group_id [String] Group ID
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/room/{roomId}/leave</tt>
          #
          # @param room_id [String] Room ID
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/user/{userId}/richmenu/{richMenuId}</tt>
          #
          # @param user_id [String] User ID. Found in the `source` object of webhook event objects. Do not use the LINE ID used in LINE.
          # @param rich_menu_id [String] ID of a rich menu
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/bulk/link</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/markAsRead</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/multicast</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/narrowcast</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/push</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/bot/pnp/push</tt>
          #
          # @param pnp_messages_request [PnpMessagesRequest] 
          # @param x_line_delivery_tag [String] String returned in the delivery.data property of the delivery completion event via Webhook.
          ...
          # Send reply message
          # This requests to <tt>POST https://api.line.me/v2/bot/message/reply</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/batch</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/user/all/richmenu/{richMenuId}</tt>
          #
          # @param rich_menu_id [String] ID of a rich menu
          ...
          # This requests to <tt>PUT https://api.line.me/v2/bot/channel/webhook/endpoint</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/chat/loading/start</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/channel/webhook/test</tt>
          #
          # @param test_webhook_endpoint_request [TestWebhookEndpointRequest] 
          ...
          # This requests to <tt>DELETE https://api.line.me/v2/bot/user/{userId}/richmenu</tt>
          #
          # @param user_id [String] User ID. Found in the `source` object of webhook event objects. Do not use the LINE ID used in LINE.
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/bulk/unlink</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/alias/{richMenuAliasId}</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/validate/broadcast</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/validate/multicast</tt>
          #
          # @param validate_message_request [ValidateMessageRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/validate/narrowcast</tt>
          #
          # @param validate_message_request [ValidateMessageRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/validate/push</tt>
          #
          # @param validate_message_request [ValidateMessageRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/message/validate/reply</tt>
          #
          # @param validate_message_request [ValidateMessageRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/validate/batch</tt>
          #
          # @param rich_menu_batch_request [RichMenuBatchRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/richmenu/validate</tt>
          #
          # @param rich_menu_request [RichMenuRequest] 
