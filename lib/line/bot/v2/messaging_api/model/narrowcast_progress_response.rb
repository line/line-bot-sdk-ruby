    ...
    module V2
      module MessagingApi
        ...
        class NarrowcastProgressResponse
          ...
          #   @return [Integer] The number of users who successfully received the message.
          attr_accessor :success_count
          # @!attribute [rw] failure_count
          #   @return [Integer] The number of users who failed to send the message.
          attr_accessor :failure_count
          # @!attribute [rw] target_count
          #   @return [Integer] The number of intended recipients of the message.
          attr_accessor :target_count
          # @!attribute [rw] failed_description
          #   @return [String] The reason the message failed to be sent. This is only included with a `phase` property value of `failed`.
          ...
          #   @return [String] Processing of narrowcast message request completion time in milliseconds. Returned when the phase property is succeeded or failed.  Format: ISO 8601 (e.g. 2020-12-03T10:15:30.121Z) Timezone: UTC 
          ...
          # @param success_count [Integer] The number of users who successfully received the message.
          # @param failure_count [Integer] The number of users who failed to send the message.
          # @param target_count [Integer] The number of intended recipients of the message.
          # @param failed_description [String] The reason the message failed to be sent. This is only included with a `phase` property value of `failed`.
          # @param error_code [Integer] Error summary. This is only included with a phase property value of failed. One of:  `1`: An internal error occurred. `2`: An error occurred because there weren't enough recipients. `3`: A conflict error of requests occurs because a request that has already been accepted is retried. `4`: An audience of less than 50 recipients is included as a condition of sending. 
          ...
          # @param completed_time [String] Processing of narrowcast message request completion time in milliseconds. Returned when the phase property is succeeded or failed.  Format: ISO 8601 (e.g. 2020-12-03T10:15:30.121Z) Timezone: UTC 
          def initialize(
            phase:,
            success_count: nil,
            failure_count: nil,
