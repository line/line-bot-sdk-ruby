    ...
    module V2
      module MessagingApi
        ...
        class TemplateMessage < Message
          ...
          # @param template [Template, Hash[Symbol, untyped]] 
          def initialize(
            quick_reply: nil,
            sender: nil,
            alt_text:,
            ...
            **dynamic_attributes
            ...
            @alt_text = alt_text
            @template = template.is_a?(Line::Bot::V2::MessagingApi::Template) ? template : Line::Bot::V2::MessagingApi::Template.create(**template) # steep:ignore
