    ...
    module V2
      module Liff
        ...
        class LiffView
          ...
          #   @return [Boolean] `true` to use the LIFF app in modular mode. When in modular mode, the action button in the header is not displayed. 
          ...
          # @param module_mode [Boolean] `true` to use the LIFF app in modular mode. When in modular mode, the action button in the header is not displayed. 
          def initialize(
            type:,
            url:,
            module_mode: nil,
