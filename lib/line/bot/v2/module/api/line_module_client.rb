    ...
    module V2
      module Module
        class ApiClient
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/chat/{chatId}/control/acquire</tt>
          #
          # @param chat_id [String] The `userId`, `roomId`, or `groupId`
          # @param acquire_chat_control_request [AcquireChatControlRequest] 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/channel/detach</tt>
          #
          # @param detach_module_request [DetachModuleRequest] 
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/list</tt>
          #
          # @param start [String] Value of the continuation token found in the next property of the JSON object returned in the response. If you can't get all basic information about the bots in one request, include this parameter to get the remaining array. 
          # @param limit [Integer] Specify the maximum number of bots that you get basic information from. The default value is 100. Max value: 100 
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/chat/{chatId}/control/release</tt>
          #
          # @param chat_id [String] The `userId`, `roomId`, or `groupId`
