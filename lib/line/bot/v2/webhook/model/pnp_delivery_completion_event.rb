    ...
    module V2
      module Webhook
        ...
        class PnpDeliveryCompletionEvent < Event
          ...
          # @param delivery [PnpDelivery, Hash[Symbol, untyped]] 
          def initialize(
            source: nil,
            timestamp:,
            mode:,
            ...
            **dynamic_attributes
            ...
            @delivery = delivery.is_a?(Line::Bot::V2::Webhook::PnpDelivery) ? delivery : Line::Bot::V2::Webhook::PnpDelivery.create(**delivery) # steep:ignore
