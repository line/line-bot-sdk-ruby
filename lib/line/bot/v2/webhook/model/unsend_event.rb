    ...
    module V2
      module Webhook
        ...
        class UnsendEvent < Event
          ...
          # @param unsend [UnsendDetail, Hash[Symbol, untyped]] 
          def initialize(
            source: nil,
            timestamp:,
            mode:,
            ...
            **dynamic_attributes
            ...
            @unsend = unsend.is_a?(Line::Bot::V2::Webhook::UnsendDetail) ? unsend : Line::Bot::V2::Webhook::UnsendDetail.create(**unsend) # steep:ignore
