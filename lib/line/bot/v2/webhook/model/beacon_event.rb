    ...
    module V2
      module Webhook
        ...
        class BeaconEvent < Event
          ...
          # @param beacon [BeaconContent, Hash[Symbol, untyped]] 
          def initialize(
            source: nil,
            timestamp:,
            mode:,
            ...
            **dynamic_attributes
            ...
            @beacon = beacon.is_a?(Line::Bot::V2::Webhook::BeaconContent) ? beacon : Line::Bot::V2::Webhook::BeaconContent.create(**beacon) # steep:ignore
