    ...
    module V2
      module Insight
        ...
        class GetNumberOfMessageDeliveriesResponse
          # @!attribute [rw] status
          #   @return [String] ('ready'|'unready'|'out_of_service') Status of the counting process.
          attr_accessor :status
          # @!attribute [rw] broadcast
          #   @return [Integer] Number of messages sent to all of this LINE Official Account's friends (broadcast messages).
          attr_accessor :broadcast
          # @!attribute [rw] targeting
          #   @return [Integer] Number of messages sent to some of this LINE Official Account's friends, based on specific attributes (targeted messages).
          attr_accessor :targeting
          # @!attribute [rw] auto_response
          #   @return [Integer] Number of auto-response messages sent.
          attr_accessor :auto_response
          # @!attribute [rw] welcome_response
          #   @return [Integer] Number of greeting messages sent.
          attr_accessor :welcome_response
          # @!attribute [rw] chat
          #   @return [Integer] Number of messages sent from LINE Official Account Manager [Chat screen](https://www.linebiz.com/jp/manual/OfficialAccountManager/chats/) (only available in Japanese).
          attr_accessor :chat
          # @!attribute [rw] api_broadcast
          #   @return [Integer] Number of broadcast messages sent with the `Send broadcast message` Messaging API operation.
          attr_accessor :api_broadcast
          # @!attribute [rw] api_push
          #   @return [Integer] Number of push messages sent with the `Send push message` Messaging API operation.
          attr_accessor :api_push
          # @!attribute [rw] api_multicast
          #   @return [Integer] Number of multicast messages sent with the `Send multicast message` Messaging API operation.
          attr_accessor :api_multicast
          # @!attribute [rw] api_narrowcast
          #   @return [Integer] Number of narrowcast messages sent with the `Send narrowcast message` Messaging API operation.
          attr_accessor :api_narrowcast
          # @!attribute [rw] api_reply
          #   @return [Integer] Number of replies sent with the `Send reply message` Messaging API operation.
