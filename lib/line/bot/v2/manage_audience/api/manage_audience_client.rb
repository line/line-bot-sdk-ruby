    ...
    module V2
      module ManageAudience
        class ApiClient
          ...
          # Activate audience
          # This requests to <tt>PUT https://api.line.me/v2/bot/audienceGroup/{audienceGroupId}/activate</tt>
          #
          ...
          # This requests to <tt>PUT https://api.line.me/v2/bot/audienceGroup/upload</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/audienceGroup/upload</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/audienceGroup/click</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/bot/audienceGroup/imp</tt>
          #
          ...
          # Delete audience
          # This requests to <tt>DELETE https://api.line.me/v2/bot/audienceGroup/{audienceGroupId}</tt>
          #
          # @param audience_group_id [Integer] The audience ID.
          ...
          # Gets audience data.
          # This requests to <tt>GET https://api.line.me/v2/bot/audienceGroup/{audienceGroupId}</tt>
          #
          # @param audience_group_id [Integer] The audience ID.
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/audienceGroup/authorityLevel</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/audienceGroup/list</tt>
          #
          ...
          # Gets audience data.
          # This requests to <tt>GET https://api.line.me/v2/bot/audienceGroup/shared/{audienceGroupId}</tt>
          #
          # @param audience_group_id [Integer] The audience ID.
          ...
          # This requests to <tt>GET https://api.line.me/v2/bot/audienceGroup/shared/list</tt>
          #
          # @param page [Integer] The page to return when getting (paginated) results. Must be 1 or higher.
          # @param description [String] The name of the audience(s) to return. You can search for partial matches. This is case-insensitive, meaning AUDIENCE and audience are considered identical. If omitted, the name of the audience(s) will not be used as a search criterion. 
          # @param status [AudienceGroupStatus] The status of the audience(s) to return. If omitted, the status of the audience(s) will not be used as a search criterion. 
          ...
          # This requests to <tt>PUT https://api.line.me/v2/bot/audienceGroup/authorityLevel</tt>
          #
          ...
          # This requests to <tt>PUT https://api.line.me/v2/bot/audienceGroup/{audienceGroupId}/updateDescription</tt>
          #
          # @param audience_group_id [Integer] The audience ID.
