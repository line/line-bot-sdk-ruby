    ...
    module V2
      module ChannelAccessToken
        class ApiClient
          ...
          # This requests to <tt>GET https://api.line.me/oauth2/v2.1/tokens/kid</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/v2/oauth/accessToken</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/oauth2/v2.1/token</tt>
          #
          # @param grant_type [String] client_credentials
          # @param client_assertion_type [String] urn:ietf:params:oauth:client-assertion-type:jwt-bearer
          ...
          # This requests to <tt>POST https://api.line.me/oauth2/v3/token</tt>
          #
          # @param grant_type [String] `client_credentials`
          ...
          # This requests to <tt>POST https://api.line.me/v2/oauth/revoke</tt>
          #
          ...
          # This requests to <tt>POST https://api.line.me/oauth2/v2.1/revoke</tt>
          #
          # @param client_id [String] Channel ID
          # @param client_secret [String] Channel Secret
          # @param access_token [String] Channel access token
          ...
          # This requests to <tt>POST https://api.line.me/v2/oauth/verify</tt>
          #
          ...
          # This requests to <tt>GET https://api.line.me/oauth2/v2.1/verify</tt>
          #
